...
(select name, 'math' as 'subject', math as 'score' from ft2) union
(select name, 'art' as 'subject', art as 'score' from ft2) union 
(select name, 'sport' as 'subject', sport as 'score' from ft2) order by name;
